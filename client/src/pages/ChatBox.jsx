...
const ChatBox = () => {
  ...
  return user && (
    <div className='flex flex-col h-screen'>
      <div className='flex items-center gap-2 p-2 md:px-8 xl:pl-34 bg-linear-to-b from-indigo-50 to-purple-50 border-b border-gray-300'>
      ...
      <div className='p-4 md:px-8 h-full overflow-y-scroll'>
