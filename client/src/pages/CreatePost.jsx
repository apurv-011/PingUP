  ...
  return (
    <div className='min-h-screen bg-linear-to-b from-slate-50 to-white'>
      <div className='max-w-6xl mx-auto p-3'>
        ...
        {/* Form */}
        <div className='max-w-xl bg-white p-3 sm:p-6 sm:pb-2 rounded-xl shadow-md space-y-4'>
          {/* Header */}
          ...
          {/* Text area */}
          <textarea className='w-full resize-none max-h-16 mt-2 text-sm outline-none placeholder-gray-400' placeholder="What's happening?" onChange={(e) => setContent(e.target.value)} value={content} />
          {/* Images */}
          {
