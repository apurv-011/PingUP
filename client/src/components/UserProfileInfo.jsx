    ...
    return (
        <div className='relative py-4 px-6 md:px-8 bg-white'>
            <div className='flex flex-col md:flex-row items-start gap-6'>
                <div className='absolute -top-12 w-24 h-24 rounded-full border-4 border-white shadow-lg overflow-hidden bg-white'>
                    <img
                ...
                <div className='w-full pt-12 md:pt-0 md:pl-30'>
                    <div className='flex flex-col md:flex-row items-start justify-between'>
                        ...
                        {/* if user it not on the others profile that means he is opening his own profile se we will give edit button */}
                    ...
                    <p className='text-gray-700 text-sm max-w-md mt-3'>{user.bio}</p>
                    ...
                    <div className='flex items-center gap-6 mt-4 border-t border-gray-200 pt-2'>
                        <div>
