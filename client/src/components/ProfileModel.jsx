                ...
                <div className='bg-white rounded-lg shadow p-4'>
                    ...
                    <form className='space-y-4' onSubmit={handleSaveProfile}>
                        ...
                        <div className='flex flex-col items-start gap-3'>
                            <label htmlFor="profile_picture" className='block text-sm font-medium text-gray-700 mb-1'>
                                ...
                                <div className='group/profile relative'>
                                    <img src={editForm.profile_picture ? URL.createObjectURL(editForm.profile_picture) : user.profile_picture} alt="" className='w-22 h-22 rounded-full object-cover mt-2' />
                        ...
                        <div className='flex justify-end space-x-3 pt-4'>
                            ...
                            <button onClick={() => setShowEdit(false)} type='button' className='px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 cursor-pointer transition-colors'>Cancel</button>

                            <button type='submit' className='px-4 py-2 bg-linear-to-r from-indigo-500 to bg-purple-600 text-white rounded-lg hover:from-indigo-600 hover:to-purple-700 transition cursor-pointer'>Save Changes</button>
                        </div>
                    </form>
                </div>
            </div>
